...
public class ProcessJPATest {
    ...
    private static RuntimeManager getRuntimeManager(String process) {
        ...
        UserGroupCallback userGroupCallback = new DBUserGroupCallbackImpl(true);
    ...
    public static PoolingDataSource setupDataSource() {
        ...
        pds.getDriverProperties().put("url", "jdbc:mysql://localhost:3306/testrhpam700callback?pinGlobalTxToPhysicalConnection=true");
