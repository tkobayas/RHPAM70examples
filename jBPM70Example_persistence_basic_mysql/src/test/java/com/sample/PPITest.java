...
public class PPITest {
    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            ProcessInstance pi = ksession.getProcessInstance(1L);
...
//            }
    ...
    private static RuntimeManager getRuntimeManager(String process) {
        ...
        return RuntimeManagerFactory.Factory.get().newPerProcessInstanceRuntimeManager(environment, "test-deployment");
