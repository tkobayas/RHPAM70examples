    ...
    public void testProcess() throws Exception {
        ...
        try {
...

            {
                ...
                NodeInstanceLog nodeInstanceLog = (NodeInstanceLog) auditService.findNodeInstances(piid, "IntermediateCatchEvent_1").get(0);

                assertEquals(ProcessInstance.SLA_VIOLATED, (int) nodeInstanceLog.getSlaCompliance());
            }
