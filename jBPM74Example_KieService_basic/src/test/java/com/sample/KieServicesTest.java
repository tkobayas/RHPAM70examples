...
public class KieServicesTest extends AbstractKieServicesBaseTest {
    ...
    public void testStartProcess() {
        ...
        taskIds = runtimeDataService.getTasksByProcessInstanceId(processInstanceId);
        assertNotNull(taskIds);
        ...
        userTaskService.complete(taskId, "mary", null);
        
        ProcessInstanceDesc processInstance = runtimeDataService.getProcessInstanceById(processInstanceId);
        System.out.println(processInstance);
        assertEquals(ProcessInstance.STATE_COMPLETED, processInstance.getState().intValue());
    }
}