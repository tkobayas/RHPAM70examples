...
public class KieServerRestUtils {
    ...
    public static CaseServicesClient getCaseServicesClient() {
        return getCaseServicesClient(DEFAULT_USERNAME, DEFAULT_PASSWORD);
    }

    public static CaseServicesClient getCaseServicesClient(String username, String password) {
        ...
        CaseServicesClient caseServicesClient = client.getServicesClient(CaseServicesClient.class);

        return caseServicesClient;
    }
